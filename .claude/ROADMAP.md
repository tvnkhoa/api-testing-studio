...
> **Status (2026-07-21):** All sprints 00–14 are delivered and the solution builds clean. Known
> post-14 gaps tracked in the recovery backlog: `Switch`/`Variable` workflow nodes and visual
> data-mapping are not yet implemented; OpenAPI import maps method/path/headers only; Postman
> environment import and an Attachments UI are outstanding.
